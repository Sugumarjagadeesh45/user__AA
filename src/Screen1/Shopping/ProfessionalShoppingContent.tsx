// /Users/webasebrandings/Downloads/new_far-main 2/src/Screen1/Shopping/ProfessionalShoppingContent.tsx
...
const ProfessionalShoppingContent = () => {
    ...
    switch (banner.targetType) {
      ...
      case 'category':
        if (banner.targetId) {
          ...
          // You might want to implement scroll functionality here
        }
        break;
          ...
          <Image
            source={{ 
              uri: item.images && item.images.length > 0 
                ? getImageUrl(item.images[0]) // Use getImageUrl function
  ...
  const renderBannerItem = ({ item, index }: { item: Banner; index: number }) => (
    ...
    >
      <Image
        source={{ 
          uri: getImageUrl(item.bannerImage) // Use getImageUrl function
        }}
...
//               <Text style={styles.emptyText}>No products found</Text>
//               <Text style={styles.emptySubText}>
//                 {products.length === 0 ? 'No products available' : 'Try changing your category'}
//               </Text>
//             </View>
//           ) : (
//             <FlatList
